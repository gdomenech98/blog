...
<Callout emoji="💡">
A domain object must **contain all data transformations** related to **business logic** and must be abstracted from the infrastructure (as described by Eric Evans in the relationship between [Domain-Application-Infrastructure](https://www.notion.so/Architecture-patterns-794bbbc9b28d486d8bb2889d43ccaa29?pvs=21)).
</Callout>