...
### 70-80's Model-View-Controller (MVC)
...
### 80's Client-Server architecture
...
### 90's Service-Oriented Architecture (SOA)
...
### [2000 Event-Driven-Design (EDD)](../software_design/edd)
...
### [2000 Domain Driven Design (DDD)](../software_design/ddd)
...
### 2010 CQRS (Command Query Responsibility Segregation)
